...
var addToHome = (function (w) {
    var nav = w.navigator,
		...
		intl = {
		    ...
		    en_us: 'Add this calculator to your %device: Tap %icon and then select [Add to Home Screen].',
		...
		options = {
		    ...
		    message: intl.en_us, 			// Customize your message or force a language ('' = automatic)
